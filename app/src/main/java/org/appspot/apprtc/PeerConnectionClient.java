...
public class PeerConnectionClient {
    ...
    public void setAudioEnabled(final boolean enable) {
        executor.execute(() -> {
            ...
            if (localAudioTrack != null) {
                EventBus.getDefault().post(new CSIOEvents.OnMuteUnmuteAudio(!enable, localAudioTrack.id()));
    ...
    public void setVideoEnabled(final boolean enable) {
        executor.execute(() -> {
            ...
            if (localVideoTrack != null) {
                EventBus.getDefault().post(new CSIOEvents.OnVideoPlayPause(!enable, localVideoTrack.id()));
    ...
    public void createOffer() {
        executor.execute(() -> {
            if (peerConnection != null && !isError) {
                ...
                isInitiator = true;
                // send fabric setup events
                EventBus.getDefault().post(new CSIOEvents.OnFabricSetup(peerConnection));
    ...
    private class PCObserver implements PeerConnection.Observer {
        ...
        public void onSignalingChange(PeerConnection.SignalingState newState) {
            ...
            EventBus.getDefault().post(new CSIOEvents.OnICESignalingChange(newState));
        }
        ...
        public void onIceConnectionChange(final PeerConnection.IceConnectionState newState) {
            executor.execute(() -> {
                ...
                EventBus.getDefault().post(new CSIOEvents.OnICEConnectionChange(newState));
        ...
        public void onIceGatheringChange(PeerConnection.IceGatheringState newState) {
            ...
            EventBus.getDefault().post(new CSIOEvents.OnICEGatheringChanges(newState));
        }
        ...
        public void onAddStream(final MediaStream stream) {
            EventBus.getDefault().post(new CSIOEvents.OnAddRemoveStram(true));
        }

        @Override
        public void onRemoveStream(final MediaStream stream) {
            EventBus.getDefault().post(new CSIOEvents.OnAddRemoveStram(false));
        }
